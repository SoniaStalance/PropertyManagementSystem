...
{
    public partial class delWard : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "delete Ward where id='" + Request.QueryString["id"].ToString() + "'";
            try
            {
                cmd.ExecuteNonQuery();
                f = 1;
            ...
            finally
            {
                ...
                cmd1.CommandText = "select id,name,zid from Ward";
